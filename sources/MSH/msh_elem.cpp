...
Task:
Programing:
10/2014 BW Implementation, inheritated from WriteIndex_TEC();
**************************************************************************/
void CElem::WriteIndex_TECBLOCK(std::ostream &os) const
{
	std::string deli = "  ";
	if (geo_type == MshElemType::LINE)
		os << nodes_index[0] + 1 << deli << nodes_index[1] + 1 << deli << nodes_index[1] +
		...
		os << nodes_index[0] + 1 << deli << nodes_index[1] + 1 << deli << nodes_index[2] +
		1 << deli << nodes_index[0] + 1;
	else if (geo_type == MshElemType::TETRAHEDRON)
		os << nodes_index[0] + 1 << deli << nodes_index[0] + 1 << deli << nodes_index[1] +
		1 << deli << nodes_index[2] + 1 << deli
		<< nodes_index[3] + 1 << deli << nodes_index[3] + 1 << deli << nodes_index[3] +
		1 << deli << nodes_index[3] + 1 << deli;
	else if (geo_type == MshElemType::PRISM)
		os << nodes_index[0] + 1 << deli << nodes_index[0] + 1 << deli << nodes_index[1] +
		1 << deli << nodes_index[2] + 1 << deli
