...
public:                                           //OK
	...
	int reject_count; // SB
	std::string max_pv_change_pcs_name; // controlling process // SB 02/2014
	std::string max_pv_change_var_name; // variable used of controlling process
	double max_pv_change_delta_max;  // max. allowed change of variable
