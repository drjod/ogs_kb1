...
public:
	...
	void CalculateFluxThroughFace(double factor, double *NodeVal, double *NodeVal_adv, double* normal_diff_flux, double* normal_adv_flux); // JOD 2/2015

	void FaceNormalFluxIntegration(long index, double *NodeVal_adv, double *NodeVal, CRFProcess* m_pcs, double* normal_vector); // JOD 2014-11-10
