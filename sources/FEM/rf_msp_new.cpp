	...
	**************************************************************************/
	std::ios::pos_type CSolidProperties::Read(std::ifstream* msp_file)
	{
		...
		while (!new_keyword)
		{
			...
			//....................................................................
			// subkeyword found
			if (line_string.find("FREEZING_SIGMOID_COEFFICIENT") != string::npos) // BW 2022-05, correct name
			{
				in_sd.str(GetLineFromFile1(msp_file));
				in_sd >> freezing_sigmoid_coeff;
				// std::cout << freezing_sigmoid_coeff << '\n';
				in_sd.clear();
			}
			...
			//....................................................................
			// subkeyword found
			if (line_string.find("FREEZING_SIGMOID_DERIVATIVE_MODEL") != string::npos) // BW 2022-05
			{
				in_sd.str(GetLineFromFile1(msp_file));
				in_sd >> freezing_sigmoid_derivative_model;
				//std::cout << "\tVolumetric heat capacity: ";
				switch (freezing_sigmoid_derivative_model)  //BW 05/2022
				{
				case 0:  // CURVE - dependent on temperature
					in_sd >> freezing_sigmoid_derivative_model_curve_number;
					std::cout << "Curve " << freezing_sigmoid_derivative_model << '\n';
					break;
				case 1:  // Derivative model from the expotential model
					//in_sd >> freezing_sigmoid_coeff;
					//std::cout << freezing_sigmoid_coeff << '\n';
					break;
				default:
					throw std::runtime_error("FREEZING_SIGMOID_DERIVATIVE model not supported");
				}
