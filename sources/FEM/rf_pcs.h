...
protected:                                        //WW
	...
	int num_copy_gp_values;
	std::vector<long> copy_gp_values;
...
public:
	...
	//WW
	double CalcMaxPrimaryVariableChange(void); // SB_14
	void SetMaxPrimaryVariable(void);
	bool flag_delta_max; // use flag for setting time control by this process
	bool flag_delta_max_switch; // flag used for switching on pcs calulcation
	std::string pcs_name_delta_max; // this is the process controlled
	std::string var_name_delta_max;
